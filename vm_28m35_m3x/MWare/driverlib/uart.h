//###########################################################################
// FILE:   uart.h
// TITLE:  Defines and Macros for the UART.
//###########################################################################
...
// UARTParityModeGet.
//*****************************************************************************
#define UART_CONFIG_WLEN_MASK    0x00000060     // Mask for extracting word
                                                // length
#define UART_CONFIG_WLEN_8       0x00000060     // 8 bit data
#define UART_CONFIG_WLEN_7       0x00000040     // 7 bit data
#define UART_CONFIG_WLEN_6       0x00000020     // 6 bit data
#define UART_CONFIG_WLEN_5       0x00000000     // 5 bit data
#define UART_CONFIG_STOP_MASK    0x00000008     // Mask for extracting stop
                                                // bits
...
//*****************************************************************************
#define UART_FIFO_TX1_8          0x00000000     // Transmit interrupt at 1/8
                                                // Full
#define UART_FIFO_TX2_8          0x00000001     // Transmit interrupt at 1/4
                                                // Full
#define UART_FIFO_TX4_8          0x00000002     // Transmit interrupt at 1/2
                                                // Full
#define UART_FIFO_TX6_8          0x00000003     // Transmit interrupt at 3/4
                                                // Full
#define UART_FIFO_TX7_8          0x00000004     // Transmit interrupt at 7/8
                                                // Full
...
//*****************************************************************************
#define UART_FIFO_RX1_8          0x00000000     // Receive interrupt at 1/8
                                                // Full
#define UART_FIFO_RX2_8          0x00000008     // Receive interrupt at 1/4
                                                // Full
#define UART_FIFO_RX4_8          0x00000010     // Receive interrupt at 1/2
                                                // Full
#define UART_FIFO_RX6_8          0x00000018     // Receive interrupt at 3/4
                                                // Full
#define UART_FIFO_RX7_8          0x00000020     // Receive interrupt at 7/8
                                                // Full

//*****************************************************************************
// Values that can be passed to UARTDMAEnable() and UARTDMADisable().
//*****************************************************************************
#define UART_DMA_ERR_RXSTOP      0x00000004     // Stop DMA receive if UART
                                                // error
