...
#define PBIST_ALGO_TRXORR_G3				0x00800000	// 22 Triple Read XOR Read: M3 BootROM 
#define PBIST_ALGO_TRXORR_G4				0x01000000	// 23 Triple Read XOR Read: C28 BootROM 
#define PBIST_ALGO_TRXORR_G5				0x02000000	// 24 Triple Read XOR Read: C28 Self Test ROM 
#define PBIST_ALGO_TRXORR_G6				0x04000000	// 25 Triple Read XOR Read: C28 Self Test ROM1 
#define PBIST_ALGO_TRXORR_G7				0x08000000	// 26 Triple Read XOR Read: M3 Self Test ROM2 
