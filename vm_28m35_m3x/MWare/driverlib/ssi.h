//###########################################################################
// FILE:   ssi.h
// TITLE:  Prototypes for the Synchronous Serial Interface Driver.
//###########################################################################
...
//*****************************************************************************
#define SSI_FRF_MOTO_MODE_0    0x00000000       // Moto fmt, polarity 0, phase
                                                // 0
#define SSI_FRF_MOTO_MODE_1    0x00000002       // Moto fmt, polarity 0, phase
                                                // 1
#define SSI_FRF_MOTO_MODE_2    0x00000001       // Moto fmt, polarity 1, phase
                                                // 0
#define SSI_FRF_MOTO_MODE_3    0x00000003       // Moto fmt, polarity 1, phase
                                                // 1
...
#define SSI_MODE_SLAVE_OD      0x00000002       // SSI slave with output
                                                // disabled
