//###########################################################################
// FILE:   hw_epi.h
// TITLE:  Macros for use in accessing the EPI registers.
//###########################################################################
...
#define EPI_O_HB16CFG2             0x00000014 // EPI Host-Bus 16 Configuration
                                              // 2
...
#define EPI_O_HB8TIME2             0x00000314 // EPI Host-Bus 8 Timing extension 2
#define EPI_O_HB16TIME2            0x00000314 // EPI Host-Bus 16 Timing extension 2
#define EPI_O_HB8TIME3             0x00000318 // EPI Host-Bus 8 Timing extension 3
#define EPI_O_HB16TIME3            0x00000318 // EPI Host-Bus 16 Timing extension 3
#define EPI_O_HB8TIME4             0x0000031C // EPI Host-Bus 8 Timing extension 4
#define EPI_O_HB16TIME4            0x0000031C // EPI Host-Bus 16 Timing extension 4
#define EPI_O_MEMPROT              0x0002B938 // EPI Memory Protection
...
#define EPI_GPCFG_DSIZE_16BIT      0x00000001 // 16 Bits Wide (EPI0S0 to
                                              // EPI0S15)
#define EPI_GPCFG_DSIZE_24BIT      0x00000002 // 24 Bits Wide (EPI0S0 to
                                              // EPI0S23)
#define EPI_GPCFG_DSIZE_32BIT      0x00000003 // 32 Bits Wide (EPI0S0 to
                                              // EPI0S31)
...
#define EPI_HB8CFG2_CSCFG_ADCS     0x03000000 // ALE with Dual CSn
                                              // Configuration
...
#define EPI_HB16CFG2_CSCFG_ADCS    0x03000000 // ALE with Dual CSn
                                              // Configuration
...
#define EPI_ADDRMAP_EPSZ_256B      0x00000000 // 256 bytes; lower address
                                              // range: 0x00 to 0xFF
...
#define EPI_ADDRMAP_ERSZ_256B      0x00000000 // 256 bytes; lower address
                                              // range: 0x00 to 0xFF
...
#define EPI_FIFOLVL_RDFIFO_1_8     0x00000001 // Trigger when there are 1 or
                                              // more entries in the NBRFIFO
#define EPI_FIFOLVL_RDFIFO_1_4     0x00000002 // Trigger when there are 2 or
                                              // more entries in the NBRFIFO
#define EPI_FIFOLVL_RDFIFO_1_2     0x00000003 // Trigger when there are 4 or
                                              // more entries in the NBRFIFO
#define EPI_FIFOLVL_RDFIFO_3_4     0x00000004 // Trigger when there are 6 or
                                              // more entries in the NBRFIFO
#define EPI_FIFOLVL_RDFIFO_7_8     0x00000005 // Trigger when there are 7 or
                                              // more entries in the NBRFIFO
#define EPI_FIFOLVL_RDFIFO_FULL    0x00000006 // Trigger when there are 8
