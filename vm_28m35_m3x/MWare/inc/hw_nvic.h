//###########################################################################
// FILE:   hw_nvic.h
// TITLE:  Macros used when accessing the NVIC hardware.
//###########################################################################
...
//*****************************************************************************
#define NVIC_INT_TYPE                0xE000E004 // Interrupt Controller Type
                                                // Reg
#define NVIC_ST_CTRL                 0xE000E010 // SysTick Control and Status
                                                // Reg
#define NVIC_ST_RELOAD               0xE000E014 // SysTick Reload Value
                                                // Register
#define NVIC_ST_CURRENT              0xE000E018 // SysTick Current Value
                                                // Register
#define NVIC_ST_CAL                  0xE000E01C // SysTick Calibration Value
                                                // Reg
#define NVIC_EN0                     0xE000E100 // IRQ 0 to 31 Set Enable
                                                // Register
#define NVIC_EN1                     0xE000E104 // IRQ 32 to 63 Set Enable
                                                // Register
#define NVIC_EN2                     0xE000E108 // IRQ 64 to 95 Set Enable
                                                // Register
#define NVIC_DIS0                    0xE000E180 // IRQ 0 to 31 Clear Enable Reg
#define NVIC_DIS1                    0xE000E184 // IRQ 32 to 63 Clear Enable
                                                // Reg
#define NVIC_DIS2                    0xE000E188 // IRQ 64 to 95 Clear Enable
                                                // Reg
#define NVIC_PEND0                   0xE000E200 // IRQ 0 to 31 Set Pending
                                                // Register
#define NVIC_PEND1                   0xE000E204 // IRQ 32 to 63 Set Pending Reg
#define NVIC_PEND2                   0xE000E208 // IRQ 64 to 95 Set Pending Reg
#define NVIC_UNPEND0                 0xE000E280 // IRQ 0 to 31 Clear Pending
                                                // Reg
#define NVIC_UNPEND1                 0xE000E284 // IRQ 32 to 63 Clear Pending
                                                // Reg
#define NVIC_UNPEND2                 0xE000E288 // IRQ 64 to 95 Clear Pending
                                                // Reg
#define NVIC_ACTIVE0                 0xE000E300 // IRQ 0 to 31 Active Register
#define NVIC_ACTIVE1                 0xE000E304 // IRQ 32 to 63 Active Register
#define NVIC_ACTIVE2                 0xE000E308 // IRQ 64 to 95 Active Register
#define NVIC_PRI0                    0xE000E400 // IRQ 0 to 3 Priority Register
#define NVIC_PRI1                    0xE000E404 // IRQ 4 to 7 Priority Register
#define NVIC_PRI2                    0xE000E408 // IRQ 8 to 11 Priority
                                                // Register
#define NVIC_PRI3                    0xE000E40C // IRQ 12 to 15 Priority
                                                // Register
#define NVIC_PRI4                    0xE000E410 // IRQ 16 to 19 Priority
                                                // Register
#define NVIC_PRI5                    0xE000E414 // IRQ 20 to 23 Priority
                                                // Register
#define NVIC_PRI6                    0xE000E418 // IRQ 24 to 27 Priority
                                                // Register
#define NVIC_PRI7                    0xE000E41C // IRQ 28 to 31 Priority
                                                // Register
#define NVIC_PRI8                    0xE000E420 // IRQ 32 to 35 Priority
                                                // Register
#define NVIC_PRI9                    0xE000E424 // IRQ 36 to 39 Priority
                                                // Register
#define NVIC_PRI10                   0xE000E428 // IRQ 40 to 43 Priority
                                                // Register
#define NVIC_PRI11                   0xE000E42C // IRQ 44 to 47 Priority
                                                // Register
#define NVIC_PRI12                   0xE000E430 // IRQ 48 to 51 Priority
                                                // Register
#define NVIC_PRI13                   0xE000E434 // IRQ 52 to 55 Priority
                                                // Register
#define NVIC_PRI14                   0xE000E438 // IRQ 56 to 59 Priority
                                                // Register
#define NVIC_PRI15                   0xE000E43C // IRQ 60 to 63 Priority
                                                // Register
#define NVIC_PRI16                   0xE000E440 // IRQ 64 to 67 Priority
                                                // Register
#define NVIC_PRI17                   0xE000E444 // IRQ 68 to 71 Priority
                                                // Register
#define NVIC_PRI18                   0xE000E448 // IRQ 72 to 75 Priority
                                                // Register
#define NVIC_PRI19                   0xE000E44C // IRQ 76 to 79 Priority
                                                // Register
#define NVIC_PRI20                   0xE000E450 // IRQ 80 to 83 Priority
                                                // Register
#define NVIC_PRI21                   0xE000E454 // IRQ 84 to 87 Priority
                                                // Register
#define NVIC_PRI22                   0xE000E458 // IRQ 88 to 91 Priority
                                                // Register
#define NVIC_PRI23                   0xE000E45C // IRQ 92 to 95 Priority
                                                // Register
#define NVIC_CPUID                   0xE000ED00 // CPUID Base Register
#define NVIC_INT_CTRL                0xE000ED04 // Interrupt Control State
                                                // Register
...
#define NVIC_CFG_CTRL                0xE000ED14 // Configuration Control
                                                // Register
#define NVIC_SYS_PRI1                0xE000ED18 // Sys. Handlers 4 to 7
                                                // Priority
#define NVIC_SYS_PRI2                0xE000ED1C // Sys. Handlers 8 to 11
                                                // Priority
#define NVIC_SYS_PRI3                0xE000ED20 // Sys. Handlers 12 to 15
                                                // Priority
#define NVIC_SYS_HND_CTRL            0xE000ED24 // System Handler Control and
                                                // State
...
#define NVIC_MPU_BASE                0xE000ED9C // MPU Region Base Address
                                                // Register
#define NVIC_MPU_ATTR                0xE000EDA0 // MPU Region Attribute & Size
                                                // Reg
#define NVIC_DBG_CTRL                0xE000EDF0 // Debug Control and Status Reg
#define NVIC_DBG_XFER                0xE000EDF4 // Debug Core Reg. Transfer
                                                // Select
#define NVIC_DBG_DATA                0xE000EDF8 // Debug Core Register Data
#define NVIC_DBG_INT                 0xE000EDFC // Debug Reset Interrupt
                                                // Control
...
//*****************************************************************************
#define NVIC_INT_TYPE_LINES_M        0x0000001F // Number of interrupt lines
                                                // (x32)
...
#define NVIC_DIS2_INT71              0x00000800 // Interrupt 71 disable
#define NVIC_DIS2_INT70              0x00000400 // Interrupt 70 disable
#define NVIC_DIS2_INT69              0x00000200 // Interrupt 69 disable
#define NVIC_DIS2_INT68              0x00000100 // Interrupt 68 disable
#define NVIC_DIS2_INT67              0x00000080 // Interrupt 67 disable
#define NVIC_DIS2_INT66              0x00000040 // Interrupt 66 disable
#define NVIC_DIS2_INT65              0x00000020 // Interrupt 65 disable
#define NVIC_DIS2_INT64              0x00000010 // Interrupt 64 disable
#define NVIC_DIS2_INT63              0x00000008 // Interrupt 63 disable
#define NVIC_DIS2_INT62              0x00000004 // Interrupt 62 disable
#define NVIC_DIS2_INT61              0x00000002 // Interrupt 61 disable
#define NVIC_DIS2_INT60              0x00000001 // Interrupt 60 disable
...
//*****************************************************************************
#define NVIC_PEND1_INT63             0x80000000 // Interrupt 63 pend
#define NVIC_PEND1_INT62             0x40000000 // Interrupt 62 pend
#define NVIC_PEND1_INT61             0x20000000 // Interrupt 61 pend
#define NVIC_PEND1_INT60             0x10000000 // Interrupt 60 pend
...
//*****************************************************************************
#define NVIC_PEND2_INT95             0x80000000 // Interrupt 95 pend
#define NVIC_PEND2_INT94             0x40000000 // Interrupt 94 pend
#define NVIC_PEND2_INT93             0x20000000 // Interrupt 93 pend
#define NVIC_PEND2_INT92             0x10000000 // Interrupt 92 pend
#define NVIC_PEND2_INT91             0x08000000 // Interrupt 91 pend
#define NVIC_PEND2_INT90             0x04000000 // Interrupt 90 pend
#define NVIC_PEND2_INT89             0x02000000 // Interrupt 89 pend
#define NVIC_PEND2_INT88             0x01000000 // Interrupt 88 pend
#define NVIC_PEND2_INT87             0x00800000 // Interrupt 87 pend
#define NVIC_PEND2_INT86             0x00400000 // Interrupt 86 pend
#define NVIC_PEND2_INT85             0x00200000 // Interrupt 85 pend
#define NVIC_PEND2_INT84             0x00100000 // Interrupt 84 pend
#define NVIC_PEND2_INT83             0x00080000 // Interrupt 83 pend
#define NVIC_PEND2_INT82             0x00040000 // Interrupt 82 pend
#define NVIC_PEND2_INT81             0x00020000 // Interrupt 81 pend
#define NVIC_PEND2_INT80             0x00010000 // Interrupt 80 pend
#define NVIC_PEND2_INT79             0x00008000 // Interrupt 79 pend
#define NVIC_PEND2_INT78             0x00004000 // Interrupt 78 pend
#define NVIC_PEND2_INT77             0x00002000 // Interrupt 77 pend
#define NVIC_PEND2_INT76             0x00001000 // Interrupt 76 pend
#define NVIC_PEND2_INT75             0x00000800 // Interrupt 75 pend
#define NVIC_PEND2_INT74             0x00000400 // Interrupt 74 pend
#define NVIC_PEND2_INT73             0x00000200 // Interrupt 73 pend
#define NVIC_PEND2_INT72             0x00000100 // Interrupt 72 pend
#define NVIC_PEND2_INT71             0x00000800 // Interrupt 71 pend
#define NVIC_PEND2_INT70             0x00000400 // Interrupt 70 pend
#define NVIC_PEND2_INT69             0x00000200 // Interrupt 69 pend
#define NVIC_PEND2_INT68             0x00000100 // Interrupt 68 pend
#define NVIC_PEND2_INT67             0x00000080 // Interrupt 67 pend
#define NVIC_PEND2_INT66             0x00000040 // Interrupt 66 pend
#define NVIC_PEND2_INT65             0x00000020 // Interrupt 65 pend
#define NVIC_PEND2_INT64             0x00000010 // Interrupt 64 pend
#define NVIC_PEND2_INT63             0x00000008 // Interrupt 63 pend
#define NVIC_PEND2_INT62             0x00000004 // Interrupt 62 pend
#define NVIC_PEND2_INT61             0x00000002 // Interrupt 61 pend
#define NVIC_PEND2_INT60             0x00000001 // Interrupt 60 pend
...
//*****************************************************************************
#define NVIC_UNPEND1_INT63           0x80000000 // Interrupt 63 unpend
#define NVIC_UNPEND1_INT62           0x40000000 // Interrupt 62 unpend
#define NVIC_UNPEND1_INT61           0x20000000 // Interrupt 61 unpend
#define NVIC_UNPEND1_INT60           0x10000000 // Interrupt 60 unpend
...
//*****************************************************************************
#define NVIC_UNPEND2_INT95           0x80000000 // Interrupt 95 unpend
#define NVIC_UNPEND2_INT94           0x40000000 // Interrupt 94 unpend
#define NVIC_UNPEND2_INT93           0x20000000 // Interrupt 93 unpend
#define NVIC_UNPEND2_INT92           0x10000000 // Interrupt 92 unpend
#define NVIC_UNPEND2_INT91           0x08000000 // Interrupt 91 unpend
#define NVIC_UNPEND2_INT90           0x04000000 // Interrupt 90 unpend
#define NVIC_UNPEND2_INT89           0x02000000 // Interrupt 89 unpend
#define NVIC_UNPEND2_INT88           0x01000000 // Interrupt 88 unpend
#define NVIC_UNPEND2_INT87           0x00800000 // Interrupt 87 unpend
#define NVIC_UNPEND2_INT86           0x00400000 // Interrupt 86 unpend
#define NVIC_UNPEND2_INT85           0x00200000 // Interrupt 85 unpend
#define NVIC_UNPEND2_INT84           0x00100000 // Interrupt 84 unpend
#define NVIC_UNPEND2_INT83           0x00080000 // Interrupt 83 unpend
#define NVIC_UNPEND2_INT82           0x00040000 // Interrupt 82 unpend
#define NVIC_UNPEND2_INT81           0x00020000 // Interrupt 81 unpend
#define NVIC_UNPEND2_INT80           0x00010000 // Interrupt 80 unpend
#define NVIC_UNPEND2_INT79           0x00008000 // Interrupt 79 unpend
#define NVIC_UNPEND2_INT78           0x00004000 // Interrupt 78 unpend
#define NVIC_UNPEND2_INT77           0x00002000 // Interrupt 77 unpend
#define NVIC_UNPEND2_INT76           0x00001000 // Interrupt 76 unpend
#define NVIC_UNPEND2_INT75           0x00000800 // Interrupt 75 unpend
#define NVIC_UNPEND2_INT74           0x00000400 // Interrupt 74 unpend
#define NVIC_UNPEND2_INT73           0x00000200 // Interrupt 73 unpend
#define NVIC_UNPEND2_INT72           0x00000100 // Interrupt 72 unpend
#define NVIC_UNPEND2_INT71           0x00000800 // Interrupt 71 unpend
#define NVIC_UNPEND2_INT70           0x00000400 // Interrupt 70 unpend
#define NVIC_UNPEND2_INT69           0x00000200 // Interrupt 69 unpend
#define NVIC_UNPEND2_INT68           0x00000100 // Interrupt 68 unpend
#define NVIC_UNPEND2_INT67           0x00000080 // Interrupt 67 unpend
#define NVIC_UNPEND2_INT66           0x00000040 // Interrupt 66 unpend
#define NVIC_UNPEND2_INT65           0x00000020 // Interrupt 65 unpend
#define NVIC_UNPEND2_INT64           0x00000010 // Interrupt 64 unpend
#define NVIC_UNPEND2_INT63           0x00000008 // Interrupt 63 unpend
#define NVIC_UNPEND2_INT62           0x00000004 // Interrupt 62 unpend
#define NVIC_UNPEND2_INT61           0x00000002 // Interrupt 61 unpend
#define NVIC_UNPEND2_INT60           0x00000001 // Interrupt 60 unpend
...
//*****************************************************************************
#define NVIC_ACTIVE1_INT63           0x80000000 // Interrupt 63 active
#define NVIC_ACTIVE1_INT62           0x40000000 // Interrupt 62 active
#define NVIC_ACTIVE1_INT61           0x20000000 // Interrupt 61 active
#define NVIC_ACTIVE1_INT60           0x10000000 // Interrupt 60 active
...
//*****************************************************************************
#define NVIC_ACTIVE2_INT95           0x80000000 // Interrupt 95 active
#define NVIC_ACTIVE2_INT94           0x40000000 // Interrupt 94 active
#define NVIC_ACTIVE2_INT93           0x20000000 // Interrupt 93 active
#define NVIC_ACTIVE2_INT92           0x10000000 // Interrupt 92 active
#define NVIC_ACTIVE2_INT91           0x08000000 // Interrupt 91 active
#define NVIC_ACTIVE2_INT90           0x04000000 // Interrupt 90 active
#define NVIC_ACTIVE2_INT89           0x02000000 // Interrupt 89 active
#define NVIC_ACTIVE2_INT88           0x01000000 // Interrupt 88 active
#define NVIC_ACTIVE2_INT87           0x00800000 // Interrupt 87 active
#define NVIC_ACTIVE2_INT86           0x00400000 // Interrupt 86 active
#define NVIC_ACTIVE2_INT85           0x00200000 // Interrupt 85 active
#define NVIC_ACTIVE2_INT84           0x00100000 // Interrupt 84 active
#define NVIC_ACTIVE2_INT83           0x00080000 // Interrupt 83 active
#define NVIC_ACTIVE2_INT82           0x00040000 // Interrupt 82 active
#define NVIC_ACTIVE2_INT81           0x00020000 // Interrupt 81 active
#define NVIC_ACTIVE2_INT80           0x00010000 // Interrupt 80 active
#define NVIC_ACTIVE2_INT79           0x00008000 // Interrupt 79 active
#define NVIC_ACTIVE2_INT78           0x00004000 // Interrupt 78 active
#define NVIC_ACTIVE2_INT77           0x00002000 // Interrupt 77 active
#define NVIC_ACTIVE2_INT76           0x00001000 // Interrupt 76 active
#define NVIC_ACTIVE2_INT75           0x00000800 // Interrupt 75 active
#define NVIC_ACTIVE2_INT74           0x00000400 // Interrupt 74 active
#define NVIC_ACTIVE2_INT73           0x00000200 // Interrupt 73 active
#define NVIC_ACTIVE2_INT72           0x00000100 // Interrupt 72 active
#define NVIC_ACTIVE2_INT71           0x00000800 // Interrupt 71 active
#define NVIC_ACTIVE2_INT70           0x00000400 // Interrupt 70 active
#define NVIC_ACTIVE2_INT69           0x00000200 // Interrupt 69 active
#define NVIC_ACTIVE2_INT68           0x00000100 // Interrupt 68 active
#define NVIC_ACTIVE2_INT67           0x00000080 // Interrupt 67 active
#define NVIC_ACTIVE2_INT66           0x00000040 // Interrupt 66 active
#define NVIC_ACTIVE2_INT65           0x00000020 // Interrupt 65 active
#define NVIC_ACTIVE2_INT64           0x00000010 // Interrupt 64 active
#define NVIC_ACTIVE2_INT63           0x00000008 // Interrupt 63 active
#define NVIC_ACTIVE2_INT62           0x00000004 // Interrupt 62 active
#define NVIC_ACTIVE2_INT61           0x00000002 // Interrupt 61 active
#define NVIC_ACTIVE2_INT60           0x00000001 // Interrupt 60 active
...
#define NVIC_INT_CTRL_PENDSTSET      0x04000000 // Set pending SysTick
                                                // interrupt
#define NVIC_INT_CTRL_PENDSTCLR      0x02000000 // Clear pending SysTick
                                                // interrupt
...
//*****************************************************************************
#define NVIC_CFG_CTRL_BFHFNMIGN      0x00000100 // Ignore bus fault in
                                                // NMI/fault
...
#define NVIC_SYS_PRI1_USAGE_M        0x00FF0000 // Priority of usage fault
                                                // handler
#define NVIC_SYS_PRI1_BUS_M          0x0000FF00 // Priority of bus fault
                                                // handler
#define NVIC_SYS_PRI1_MEM_M          0x000000FF // Priority of mem manage
                                                // handler
...
#define NVIC_SYS_PRI2_RES_M          0x00FFFFFF // Priority of reserved
                                                // handlers
...
//*****************************************************************************
#define NVIC_MPU_CTRL_PRIVDEFEN      0x00000004 // MPU default region in priv
                                                // mode
...
#define NVIC_MPU_ATTR_AP_NO_NO       0x00000000 // prv: no access, usr: no
                                                // access
...
#define NVIC_DBG_CTRL_S_RESET_ST     0x02000000 // Core has reset since last
                                                // read
#define NVIC_DBG_CTRL_S_RETIRE_ST    0x01000000 // Core has executed insruction
                                                // since last read
...
#define NVIC_DBG_CTRL_S_REGRDY       0x00010000 // Register read/write
                                                // available
#define NVIC_DBG_CTRL_C_SNAPSTALL    0x00000020 // Breaks a stalled load/store
#define NVIC_DBG_CTRL_C_MASKINT      0x00000008 // Mask interrupts when
                                                // stepping
...
#define NVIC_DBG_XFER_REG_CFBP       0x00000014 // Control/Fault
                                                // BasePri/PriMask
...
#define NVIC_DBG_INT_INTERR          0x00000200 // Debug trap on interrupt
                                                // errors
#define NVIC_DBG_INT_BUSERR          0x00000100 // Debug trap on bus error
#define NVIC_DBG_INT_STATERR         0x00000080 // Debug trap on usage fault
                                                // state
#define NVIC_DBG_INT_CHKERR          0x00000040 // Debug trap on usage fault
                                                // check
#define NVIC_DBG_INT_NOCPERR         0x00000020 // Debug trap on coprocessor
                                                // error
#define NVIC_DBG_INT_MMERR           0x00000010 // Debug trap on mem manage
                                                // fault
